...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { capital: @state.capital, population: @state.population, state: @state.state } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { capital: @state.capital, population: @state.population, state: @state.state } }
